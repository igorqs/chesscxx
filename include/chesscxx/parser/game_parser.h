#ifndef CHESSCXX_INCLUDE_CHESSCXX_PARSER_GAME_PARSER_H_
#define CHESSCXX_INCLUDE_CHESSCXX_PARSER_GAME_PARSER_H_
...
#endif  // CHESSCXX_INCLUDE_CHESSCXX_PARSER_GAME_PARSER_H_
