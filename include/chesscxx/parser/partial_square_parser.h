#ifndef CHESSCXX_INCLUDE_CHESSCXX_PARSER_PARTIAL_SQUARE_PARSER_H_
#define CHESSCXX_INCLUDE_CHESSCXX_PARSER_PARTIAL_SQUARE_PARSER_H_
...
#endif  // CHESSCXX_INCLUDE_CHESSCXX_PARSER_PARTIAL_SQUARE_PARSER_H_
