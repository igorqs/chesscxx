#ifndef CHESSCXX_INCLUDE_CHESSCXX_CORE_INTERNAL_CASTLING_RULES_H_
#define CHESSCXX_INCLUDE_CHESSCXX_CORE_INTERNAL_CASTLING_RULES_H_
...
#endif  // CHESSCXX_INCLUDE_CHESSCXX_CORE_INTERNAL_CASTLING_RULES_H_
