#ifndef CHESSCXX_INCLUDE_CHESSCXX_CORE_INTERNAL_SQUARE_H_
#define CHESSCXX_INCLUDE_CHESSCXX_CORE_INTERNAL_SQUARE_H_
...
constexpr auto squareColor(const Square& square) -> Color {
  auto parity =
      static_cast<uint8_t>(index(square.file) + index(square.rank)) & 1U;
...
#endif  // CHESSCXX_INCLUDE_CHESSCXX_CORE_INTERNAL_SQUARE_H_
