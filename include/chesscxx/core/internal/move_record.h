#ifndef CHESSCXX_INCLUDE_CHESSCXX_CORE_INTERNAL_MOVE_RECORD_H_
#define CHESSCXX_INCLUDE_CHESSCXX_CORE_INTERNAL_MOVE_RECORD_H_
...
#endif  // CHESSCXX_INCLUDE_CHESSCXX_CORE_INTERNAL_MOVE_RECORD_H_
