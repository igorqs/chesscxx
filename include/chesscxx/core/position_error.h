#ifndef CHESSCXX_INCLUDE_CHESSCXX_CORE_POSITION_ERROR_H_
#define CHESSCXX_INCLUDE_CHESSCXX_CORE_POSITION_ERROR_H_
...
#endif  // CHESSCXX_INCLUDE_CHESSCXX_CORE_POSITION_ERROR_H_
