#ifndef CHESSCXX_INCLUDE_CHESSCXX_CORE_MOVE_ERROR_H_
#define CHESSCXX_INCLUDE_CHESSCXX_CORE_MOVE_ERROR_H_
...
#endif  // CHESSCXX_INCLUDE_CHESSCXX_CORE_MOVE_ERROR_H_
