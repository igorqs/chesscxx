#ifndef CHESSCXX_INCLUDE_CHESSCXX_CORE_CASTLING_RIGHTS_H_
#define CHESSCXX_INCLUDE_CHESSCXX_CORE_CASTLING_RIGHTS_H_
...
class CastlingRights {
 public:
  ...
  void enable(const Color& color) {
    castling_rights_.set(index(chesscxx::CastlingSide::kKingside, color));
    castling_rights_.set(index(chesscxx::CastlingSide::kQueenside, color));
  }
  ...
  void disable(const Color& color) {
    castling_rights_.reset(index(chesscxx::CastlingSide::kKingside, color));
    castling_rights_.reset(index(chesscxx::CastlingSide::kQueenside, color));
  }
...
#endif  // CHESSCXX_INCLUDE_CHESSCXX_CORE_CASTLING_RIGHTS_H_
