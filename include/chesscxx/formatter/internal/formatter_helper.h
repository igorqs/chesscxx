#ifndef CHESSCXX_INCLUDE_CHESSCXX_FORMATTER_INTERNAL_FORMATTER_HELPER_H_
#define CHESSCXX_INCLUDE_CHESSCXX_FORMATTER_INTERNAL_FORMATTER_HELPER_H_
...
#endif  // CHESSCXX_INCLUDE_CHESSCXX_FORMATTER_INTERNAL_FORMATTER_HELPER_H_
