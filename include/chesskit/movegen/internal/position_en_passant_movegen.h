...
inline std::generator<RawMove> pseudoLegalEnPassantCaptures(
...
inline std::generator<RawMove> legalEnPassantCaptures(const Position position) {
...
inline bool hasLegalEnPassantCapture(const Position position) {
