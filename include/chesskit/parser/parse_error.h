#ifndef CHESSKIT_INCLUDE_CHESSKIT_PARSER_PARSE_ERROR_H_
#define CHESSKIT_INCLUDE_CHESSKIT_PARSER_PARSE_ERROR_H_
...
#endif  // CHESSKIT_INCLUDE_CHESSKIT_PARSER_PARSE_ERROR_H_
