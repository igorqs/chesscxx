#ifndef CHESSKIT_INCLUDE_CHESSKIT_PARSER_PARSE_H_
#define CHESSKIT_INCLUDE_CHESSKIT_PARSER_PARSE_H_
...
inline constexpr std::expected<T, ParseError> parse(
    std::string_view sv, Tag tag = parse_as::Default{}) {
...
#endif  // CHESSKIT_INCLUDE_CHESSKIT_PARSER_PARSE_H_
